    ...
    <div className="p-8 max-w-4xl mx-auto my-12 bg-white rounded-lg shadow-lg">
      ...
      {dashboardData && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
          <div className="bg-gray-50 p-4 rounded-lg shadow-md text-center border-amber-500 border-1">
            <h3 className="text-lg font-semibold text-amber-600">Serviços em Andamento</h3>
            <p className="text-3xl font-bold text-black">{dashboardData.services_in_progress_count}</p>
          </div>
          <div className="bg-gray-50 p-4 rounded-lg shadow-md text-center border-amber-500 border-1">
            <h3 className="text-lg font-semibold text-amber-500">Peças com Estoque Baixo</h3>
            <p className="text-3xl font-bold text-black">{dashboardData.low_stock_parts_count}</p>
          </div>
        </div>
      )}
