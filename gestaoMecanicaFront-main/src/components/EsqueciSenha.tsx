  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white p-8 rounded-[20px] shadow-2xl max-w-md w-full transform transition-all flex flex-col items-center">
        ...
        <p className="text-black text-sm mb-8 px-2 text-center">
        ...
        <form onSubmit={handleSubmit} className="w-full space-y-6">
          ...
          <div className="flex flex-row w-full gap-4 pt-4">
            <button
              type="button"
              onClick={onClose}
              className="w-1/2 py-2 bg-white border-2 border-amber-500 text-amber-500 font-bold rounded-full hover:bg-amber-50 transition-all"
            >
              Cancelar
            </button>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-1/2 py-2 bg-amber-500 hover:bg-amber-600 text-white font-bold rounded-full transition-all shadow-md flex justify-center items-center"
            >
